...
@Component({
  selector: 'app-integra-one',
  templateUrl: './integra-one.component.html',
  styleUrls: ['./integra-one.component.scss']
})
export class IntegraOneComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.route.queryParams.subscribe(params => {
      ...
      this.config.getHttp('getAllMarkoprintPremiumSystemsById?id=' + this.id.id, '').then((data: any) => {
