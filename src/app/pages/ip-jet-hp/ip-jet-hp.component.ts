...
@Component({
  selector: 'app-ip-jet-hp',
  templateUrl: './ip-jet-hp.component.html',
  styleUrls: ['./ip-jet-hp.component.scss']
})
export class IpJetHpComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.route.queryParams.subscribe(params => {
      ...
      console.log(this.id)
      this.config.getHttp('getAllMarkoprintProfessionalSystemsById?id=' + this.id.id, '').then((data: any) => {
